...
public class CargaActualizarActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_carga_actualizar);
    ...
    public void actualizarC(View v) {
        ...
        carga.setIdCarga(idCarga1.getText().toString());
        carga.setCodAsignatura(codAsignatura);
        carga.setIdTipoCarga(idTipoCarga);
        carga.setNumGrupo(Integer.parseInt(editGrupo.getText().toString()));
        helper.abrir();
        String estado = helper.actualizar(carga);
        helper.cerrar();
